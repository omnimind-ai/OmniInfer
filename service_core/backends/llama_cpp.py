...
LINUX_LLAMA_CPP_TEMPLATES: tuple[BackendTemplate, ...] = (
    ...
    BackendTemplate(
        id="omniinfer-native-linux",
        label="OmniInfer Native Linux (EAGLE3)",
        family="llama.cpp",
        runtime_dir_name="omniinfer-native-linux",
        launcher_name="llama-server",
        description="OmniInfer Native Linux backend with EAGLE3 speculative decoding",
        capabilities=("chat", "vision", "stream", "gpu", "vulkan", "linux", "eagle3"),
        env_prefix="OMNIINFER_NATIVE_LINUX",
        default_ngl="999",
    ),
    BackendTemplate(
