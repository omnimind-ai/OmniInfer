...
LINUX_LLAMA_CPP_TEMPLATES: tuple[BackendTemplate, ...] = (
    BackendTemplate(
        ...
        launcher_name="llama-server",
        description="llama.cpp Linux CPU backend managed by OmniInfer",
    ...
    BackendTemplate(
        ...
        family="llama.cpp",
        runtime_dir_name="llama.cpp-linux-cuda",
        launcher_name="llama-server",
        description="llama.cpp Linux CUDA backend managed by OmniInfer",
        capabilities=("chat", "vision", "stream", "gpu", "cuda", "linux"),
        env_prefix="OMNIINFER_LLAMA_CPP_LINUX_CUDA",
        default_ngl="999",
    ),
    BackendTemplate(
