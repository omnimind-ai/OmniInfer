...
extern "C" {
    ...
    // Group direct host writes to a backend buffer into one synchronization transaction
    typedef bool                         (*ggml_backend_buffer_host_write_t)(ggml_backend_buffer_t buffer);
