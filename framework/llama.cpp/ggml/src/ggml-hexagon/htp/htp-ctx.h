...
enum htp_spad_format {
    HTP_SPAD_FORMAT_NONE = 0,
    HTP_SPAD_FORMAT_F16,
    HTP_SPAD_FORMAT_F32,
    HTP_SPAD_FORMAT_Q8_0X4X2,
    HTP_SPAD_FORMAT_Q8_1X4X2,
};
...
struct htp_spad {
    ...
    enum htp_spad_format      format;           // representation stored in this spad
};
