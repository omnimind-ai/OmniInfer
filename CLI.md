...
- Android direct mode uses [platform/Android/bin/omniinfer-android](platform/Android/bin/omniinfer-android).
- Android backend binaries live under [platform/Android/lib/arm64-v8a](platform/Android/lib/arm64-v8a).
- For more Android-specific details, see [platform/Android/README.md](platform/Android/README.md).
