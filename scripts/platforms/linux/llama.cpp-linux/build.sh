...
usage() {
  cat <<'EOF'
Usage: build-llama-linux.sh [options]
...
PACKAGE_ROOT="${REPO_ROOT}/.local/runtime/linux/llama.cpp-linux"
LLAMA_ROOT="${REPO_ROOT}/framework/llama.cpp"
BUILD_ROOT="${PACKAGE_ROOT}/build/llama.cpp-linux"
...
echo "Configuring llama.cpp Linux CPU build..."
...
echo
echo "Linux CPU build complete."
echo "Binary package location: ${BIN_ROOT}"
echo "Models directory: ${MODELS_ROOT}"
echo "Next step:"
echo "  ./omniinfer backend select llama.cpp-linux"
