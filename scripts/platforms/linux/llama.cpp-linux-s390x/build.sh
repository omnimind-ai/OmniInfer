...
usage() {
  cat <<'EOF'
Usage: build-llama-linux-s390x.sh [options]
...
PACKAGE_ROOT="${REPO_ROOT}/.local/runtime/linux/llama.cpp-linux-s390x"
LLAMA_ROOT="${REPO_ROOT}/framework/llama.cpp"
BUILD_ROOT="${PACKAGE_ROOT}/build/llama.cpp-linux-s390x"
...
echo "Configuring llama.cpp Linux s390x build..."
